              ...
              <ScrollReveal>
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start gap-4">
                    <span className="inline-flex items-center px-6 py-3.5 bg-[#D946EF] text-white rounded-full font-semibold">
                  ...
                  >
                    <div className="phone-mockup relative" style={{ width: 280, height: 570 }}>
                      <div className="absolute inset-0 overflow-hidden rounded-[28px]">
                        <Image
                          src="/images/screenshots/events/Events HomeUpcoming.png"
