...
const slides = [
  ...
  },
  {
    ...
    tagline: "Find Trusted Care",
    description: "Find trusted babysitters and childcare providers nearby.",
    bgColor: "#F0FDF4",
    accentColor: "#10B981",
    accentLight: "#D1FAE5",
    logo: "/images/logos/childcare.png",
    screenshot: "/images/screenshots/childcare/home.png",
    cta: "Learn More",
    link: "/childcare",
    isExternal: false,
  },
  {
    id: "venues",
    name: "KidZoo Venues",
    tagline: "Book Party Venues",
    description: "Find and book the perfect party venue for your celebration.",
    bgColor: "#EEF2FF",
    accentColor: "#6366F1",
    accentLight: "#E0E7FF",
    logo: "/images/logos/venues.png",
    screenshot: "/images/screenshots/venues/Party Site Options Selected.png",
    cta: "Learn More",
    link: "/venues",
    isExternal: false,
  },
  {
    id: "cakes",
    name: "KidZoo Cakes",
    tagline: "Order Custom Cakes",
    description: "Order custom cakes and treats from local bakers.",
    bgColor: "#FFF7ED",
    accentColor: "#F97316",
    accentLight: "#FFEDD5",
    logo: "/images/logos/cakes.png",
    screenshot: "/images/screenshots/cakes/browse.png",
    cta: "Learn More",
    link: "/cakes",
    isExternal: false,
  },
  {
    id: "parties",
    name: "KidZoo Parties",
    tagline: "Plan Perfect Parties",
    description: "Plan unforgettable birthday parties and celebrations.",
    bgColor: "#FCE7F3",
    accentColor: "#EC4899",
    accentLight: "#FCE7F3",
    logo: "/images/logos/parties.png",
    screenshot: "/images/screenshots/parties/home.png",
    cta: "Learn More",
    link: "/parties",
    isExternal: false,
  },
